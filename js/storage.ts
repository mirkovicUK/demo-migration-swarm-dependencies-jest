...
export function loadBoard(): import('./board.js').Board | null {
...
export function saveBoard(board: import('./board.js').Board): void {
  localStorage.setItem(STORAGE_KEY, JSON.stringify(board));
}

export async function loadOrCreateBoard(): Promise<import('./board.js').Board> {
